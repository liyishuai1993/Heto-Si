        ...
        <div>
            ...
            <div>
                ...
                <table border="0" aria-haspopup="False" class="auto-style1" style="width: 1200px">
                    ...
                    <tr>
                        <td class="auto-style3">供应商<asp:TextBox ID="gys" runat="server" Height="16px" Width="500px"></asp:TextBox>
                        </td>
                        <td class="auto-style3">煤场名称<asp:TextBox ID="mcmc" runat="server" Height="16px" Width="500px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="auto-style3">物料名称<asp:TextBox ID="wlmc" runat="server" Height="16px" Width="500px" CssClass="auto-style4"></asp:TextBox>
                        </td>
                        <td class="auto-style3">采样人<asp:TextBox ID="cyr" runat="server" Height="16px" Width="500px" CssClass="auto-style4"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style3">化验人<asp:TextBox ID="hyr" runat="server" Height="16px" Width="500px" CssClass="auto-style4"></asp:TextBox>
                        </td>
            ...
            <div>
                ...
                <p>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="xs_table" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="序号" Visible="false" DataField="xh" HeaderStyle-Width="10%">
            ...
            <p class="auto-style5">
                ...
                <asp:Button ID="update" Text="保存" runat="server" Width="90px" BorderStyle="Groove" BackColor="Aqua" OnClick="update_Click"></asp:Button>&nbsp
