<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QydbckdGl.aspx.cs" Inherits="XSSystem.Page.P_DBGL.QydbckdGl" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ShowHeaderWhenEmpty="True" EmptyDataText="查无订单" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" ShowFooter="true" OnRowDataBound="GridOrder_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ckjz"  HeaderText="出库净重">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
                <asp:BoundField DataField="dcmj"  HeaderText="调出煤价">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
                <asp:BoundField DataField="dbje"  HeaderText="调拨金额">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
