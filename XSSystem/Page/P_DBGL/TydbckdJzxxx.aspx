<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TydbckdJzxxx.aspx.cs" Inherits="XSSystem.Page.P_DBGL.TydbckdJzxxx" %>
    ...
    <div>
        <table border="1" aria-haspopup="False" class="xs_table" style="width: 400px"  >
            <tr><td class="auto-style3"><asp:TextBox ID="bh" runat="server" Height="16px" Width="284px" Visible="false"></asp:TextBox></td></tr>
                <tr>
                         <td class="auto-style3">箱号<asp:TextBox ID="xh" runat="server" Height="16px" Width="284px"></asp:TextBox></td></tr>
            ...
            <tr>       <td class="auto-style3">调出煤价<asp:TextBox id="dcmj" runat="server" height="25px" Width ="284px"></asp:TextBox> </td> </tr>
                 <tr>    <td class="auto-style3">卸货吨数<asp:TextBox id="xhds" runat="server" height="25px" Width ="284px"></asp:TextBox> </td> </tr>
            ...
            <tr>
                         <td class="auto-style3">卸货仓库<asp:TextBox ID="xhck" runat="server" Height="16px" Width="284px"></asp:TextBox></td></tr>
            ...
            <tr>       <td class="auto-style3">调入煤价<asp:TextBox id="drmj" runat="server" height="25px" Width ="284px"></asp:TextBox> </td> </tr>
            </table>
         <p class="auto-style5">
