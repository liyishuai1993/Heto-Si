   ...
   HighlightTemplatedItems="true"/> </td>
        ...
        <div style="margin-top:15px;width:1200px">
            ...
            <p>
                ...
                调出煤价<asp:TextBox id="dcmj" runat="server" Height="16px" Width ="100px" OnKeyPress="isnum()" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
                卸货吨数<asp:TextBox id="xhds" runat="server" Height="16px" Width ="100px" OnKeyPress="isnum()" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
