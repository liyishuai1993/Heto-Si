<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QydbhdGl.aspx.cs" Inherits="XSSystem.Page.P_DBGL.QydbhdGl" %>
...
<%--        <span>名称：</span>
        ...
        <%--</asp:Dropdownlist>--%>
                入库时间<asp:TextBox ID="qdfwQ" runat="server" Text="" onClick="WdatePicker()" Width="140px"></asp:TextBox>～
                ...
                收煤煤场<asp:TextBox id="tbsmmc" runat="server" Width="140px"></asp:TextBox>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="smmc"  HeaderText="收煤煤场">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="drje"  HeaderText="调入金额">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
                <asp:BoundField DataField="drmj"  HeaderText="调入煤价">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
