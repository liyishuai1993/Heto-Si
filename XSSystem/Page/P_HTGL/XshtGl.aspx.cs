...
{
    public partial class XshtGl : AuthWebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                tjz.Text = Session["selectedItemXsht"]?.ToString();
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            dml.Add("@htbhArr", ckb);
            if (_htglLogic.DeleteData(dml, "xs_XshtTable","htbh"))
            {
                AlertMessage("订单删除成功");
            }
            else
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (_htglLogic.DeleteUser(dml, "xs_XshtTable"))
            {
                AlertMessage("订单删除成功");
            }
            else
        ...
        {
            JavaScript("window.location.href='Xsht.aspx'");
      ...
      //  XshtClass xshtClass;
        ...
        {
            Session["selectedItemXsht"] = tjz.Text.Trim();
            IsAll = false;
            xsPage.RefreshPage();
        }
