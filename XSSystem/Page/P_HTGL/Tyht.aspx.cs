...
namespace XSSystem.Page.P_Order
{
    public partial class Tyht : AuthWebPage
    {
        ...
        public void InitData(object mk)
        {
            ...
            tk_wtf.Text = dt.Rows[0][4].ToString();
            tk_stf.Text = dt.Rows[0][5].ToString();
            tk_fmmc.Text = dt.Rows[0][6].ToString();
            tk_wlmc.Text = dt.Rows[0][7].ToString();
            zxqxQ.Text = dt.Rows[0][8].ToString();
            zxqxZ.Text = dt.Rows[0][9].ToString();
            tk_zcz.Text = dt.Rows[0][10].ToString();
            tk_zdz.Text = dt.Rows[0][11].ToString();
