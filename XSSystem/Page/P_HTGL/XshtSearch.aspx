<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XshtSearch.aspx.cs" Inherits="XSSystem.Page.P_Order.XshtSearch" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <p>
        <span>类别</span>
        <asp:Dropdownlist id="ddlnewtype" runat="server" autopostback="true"></asp:Dropdownlist>
                ...
                <asp:TemplateField HeaderText="操作" HeaderStyle-Width="5%">
                    <ItemTemplate>
                        <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="buttonCancle" CommandArgument='<%#Eval("oid") %>'
                            OnClientClick="return confirm('是否删除？')" actionid="04"  />
