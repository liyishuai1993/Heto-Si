            ...
            <div class="autosize">
                ...
                <table border="0" aria-haspopup="False" class="auto-style1" style="width: 1200px; font-family: 宋体, Arial, Helvetica, sans-serif; line-height: normal; background-color: #33CCFF;">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3"><span>数量(组)</span><asp:TextBox ID="sl" name="数量" valued="must1" runat="server" Height="16px" Width="284px" OnKeyPress="isnum()" ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
                        </td>
                        <td class="auto-style3"></td>
                    </tr>
