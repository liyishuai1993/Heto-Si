    ...
    <asp:Panel ID="Panel1" runat="server" Height="185px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="zcz" HeaderStyle-Width="8%" HeaderText="装车站">
                <HeaderStyle Width="8%" />
                </asp:BoundField>
                <asp:BoundField DataField="zdz" HeaderStyle-Width="5%" HeaderText="终到站">
                <HeaderStyle Width="5%" />
                </asp:BoundField>
                <asp:BoundField DataField="xlx" HeaderStyle-Width="5%" HeaderText="箱类型">
                <HeaderStyle Width="5%" />
                </asp:BoundField>
