<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GysSearch.aspx.cs" Inherits="XSSystem.Page.P_Order.GysSearch" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="185px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="全称" DataField="qc" HeaderStyle-Width="10%" />
                <asp:BoundField HeaderText="简称" DataField="jc" HeaderStyle-Width="10%" />
