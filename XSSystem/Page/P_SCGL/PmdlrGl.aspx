<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PmdlrGl.aspx.cs" Inherits="XSSystem.Page.P_SCGL.PmdlrGl" %>
...
<%--                合同编号<asp:TextBox id="tbhtbh" runat="server" Width="80px"></asp:TextBox>--%>
                ...
                配煤日期范围<asp:TextBox ID="qdfwQ" runat="server" Text="" onClick="WdatePicker()" Width="90px"></asp:TextBox>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px" ScrollBars="Auto" Width="1200px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="pmrq"  HeaderText="配煤日期" DataFormatString="{0:yyyy-MM-dd}">
