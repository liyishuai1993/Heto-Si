    ...
    <div> <p class="auto-style5">采购入库单(合并页)</p>
        <div>
            ...
            <table border="1" aria-haspopup="False" class="auto-style1" style="width: 1600px">
                ...
                <tr>
                    ...
                    <td class="auto-style3">煤价<asp:TextBox id="mj" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox> </td>
         ...
         <div>
            ...
            <table border="1" aria-haspopup="False" class="auto-style1" style="width: 1600px" >
                ...
                <tr>
                    <td class="auto-style3">装车毛重<asp:TextBox id="zcmz" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox> </td>
                    <td class="auto-style3">装车皮重<asp:TextBox id="zcpz" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox> </td>
                    <td class="auto-style3">装车净重<asp:TextBox id="zcjz" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox></td> 
                    <td class="auto-style3">结算煤款<asp:TextBox id="jsmk" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox></td>
                </tr>
            </table>            
        </div>
        ...
        <div>
            ...
            <table border="1" aria-haspopup="False" class="auto-style1" style="width: 1600px" >
                ...
                <tr>
                    <td class="auto-style3">入库磅单号<asp:TextBox ID="rkbdh" runat="server" Height="16px" Width="284px" OnKeyPress="isnum()"></asp:TextBox></td>
                    <td class="auto-style3">入库煤场<asp:TextBox ID="rkmc" runat="server" Height="16px" Width="284px" OnKeyPress="isnum()"></asp:TextBox></td>
                    <td class="auto-style3">入库毛重<asp:TextBox ID="rkmz" runat="server" Text=""  Width="284px" OnKeyPress="isnum()"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td class="auto-style3">运输路耗标准(吨)<asp:TextBox id="yslhbz" runat="server" Height="16px" Width ="253px" OnKeyPress="isnum()"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style3">已付油卡<asp:TextBox id="yfyk" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"></asp:TextBox></td> 
