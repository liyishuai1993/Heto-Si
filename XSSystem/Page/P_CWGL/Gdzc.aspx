        ...
        <div>
            ...
            <table border="0" aria-haspopup="False" class="auto-style1" style="width: 1200px" >
                ...
                <tr>
                    ...
                    <td class="auto-style3">实付金额<asp:TextBox id="zjzj_zh" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"  ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox></td> 
                </tr>    
                <tr>
        ...
        <div>
            ...
            <table border="0" aria-haspopup="False" class="auto-style1" style="width: 1200px" >
                ...
                <tr>
                    ...
                    <td class="auto-style3">实收金额<asp:TextBox id="zjjs_zh" runat="server" Height="16px" Width ="284px" OnKeyPress="isnum()"  ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox></td> 
                </tr>
            </table>     
