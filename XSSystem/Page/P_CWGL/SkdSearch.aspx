<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkdSearch.aspx.cs" Inherits="XSSystem.Page.P_Order.SkdSearch" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="185px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="收款日期" DataField="skrq" HeaderStyle-Width="10%" />

                <asp:BoundField HeaderText="需方名称" DataField="xfmc" HeaderStyle-Width="10%" />
                <asp:BoundField HeaderText="收款类型" DataField="sklx" HeaderStyle-Width="10%" />
                <asp:BoundField HeaderText="合同编号" DataField="htbh" HeaderStyle-Width="10%" />
                <asp:BoundField HeaderText="批次编号" DataField="pcbh" HeaderStyle-Width="5%" />
