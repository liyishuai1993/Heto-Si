        ...
        <div>
            ...
            <div style="width:1200px;margin-top:20px;" >
                <div style="margin-bottom:20px">
                    ...
                    <p>
                    备注<asp:TextBox runat="server" ID="bz"  Width="600px"/></p>
                </div>
                <asp:GridView ID="GridView1" runat="server" CssClass="xs_table" Width="900px" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" EmptyDataText="无记录" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <p class="auto-style7">
                优惠金额<asp:TextBox ID="yhje" Text="0" runat="server" Height="16px" Width="80px" OnKeyPress="isnum()" ToolTip="纯数字" AutoPostBack="true" OnTextChanged="yhje_TextChanged" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
                合计金额<asp:TextBox ID="hjje" Text="0" ReadOnly="true" runat="server" Height="16px" Width="80px" OnKeyPress="isnum()" ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
            </p>
