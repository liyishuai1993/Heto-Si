...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    text-align: center;
    border-style: none;
    width: 900px; font-family: 宋体, Arial, Helvetica, sans-serif; line-height: normal; background-color: #33CCFF;
        }
        .auto-style3 {
            height: 20px;
            width:300px;
...
<body>
    ...
    <div> <p class="auto-style5">费用单</p>
        ...
        <p class="auto-style4"><span>录单日期</span><asp:TextBox id="ldrq" runat="server" Height="16px" Width ="184px" Text="" onClick="WdatePicker()" valued="must1"></asp:TextBox>
            <span>编号</span><asp:TextBox ID="bh" runat="server" Height="16px" Width="184px" Enabled="false"></asp:TextBox></p>
        <div>
  ...
  EmptyMessage="请输入经手人"   MarkFirstMatch="true"  EnableLoadOnDemand="true" Filter="Contains" name="经手人" valued="must1" 
   HighlightTemplatedItems="true"/>
                    ...
                    <td class="auto-style3"><span>部门</span><asp:TextBox id="bm" runat="server" Height="16px" Width ="184px" name="部门" valued="must1" ></asp:TextBox> </td>
                </tr>
                <tr>
                    <td class="auto-style3" >摘要<asp:DropDownList id="dp_zy" runat="server" Height="24px" Width ="184px">
                        <asp:ListItem>报销</asp:ListItem>
                                              </asp:DropDownList> </td>
                    <td class="auto-style3" >附加说明<asp:TextBox id="fjsm" runat="server" Height="16px" Width ="184px"></asp:TextBox> </td>
                </tr>
                <tr>
