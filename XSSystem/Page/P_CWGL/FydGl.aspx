<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FydGl.aspx.cs" Inherits="XSSystem.Page.P_Order.FydGl" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px" ScrollBars="Auto" Width="1300px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sfdw"  HeaderText="收费单位">
                ...
                <asp:BoundField DataField="zy"  HeaderText="摘要">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
