...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p class="auto-style4">
                <span>录单日期</span><asp:TextBox ID="ldrq" runat="server" Height="16px" Width="284px" Text="" onClick="WdatePicker()"></asp:TextBox>
                编号<asp:TextBox ID="bh" runat="server" Enabled="false" Height="16px" Width="284px"></asp:TextBox>
            </p>
            <div>
            ...
            <p class="auto-style7">
                优惠金额<asp:TextBox ID="yhje" runat="server" Height="16px" Width="80px" OnKeyPress="isnum()" ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')">

                </asp:TextBox>合计金额<asp:TextBox ID="hjje" runat="server" Height="16px" Width="80px" OnKeyPress="isnum()" ToolTip="纯数字" OnKeyUp="value=value.replace(/[^\d.]/g,'')"></asp:TextBox>
            </p>
