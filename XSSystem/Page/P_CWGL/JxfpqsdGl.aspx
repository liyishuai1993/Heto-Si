<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JxfpqsdGl.aspx.cs" Inherits="XSSystem.Page.P_Order.JxfpqsdGl" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px" ScrollBars="Auto" Width="1500px">
        <asp:GridView ID="GridOrder" runat="server" CssClass="xs_table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <ItemTemplate>
                    <input type="checkbox" id="checkboxname" name="checkboxname" value='<%# DataBinder.Eval(Container.DataItem, "dh")%>' onclick='SingleCheckJs();' />
                </ItemTemplate>
                ...
                <asp:BoundField DataField="se"  HeaderText="税额">
                <HeaderStyle HorizontalAlign="Left" Width="10%" />
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                </asp:BoundField>
                ...
                <ItemStyle HorizontalAlign="Left" Width="10%" />
                    <ItemTemplate>                                 
                        <asp:Button ID="btnUpdate" runat="server" actionid="04" CommandArgument='<%#Eval("dh") %>' CssClass="buttonCancle" OnClick="btnUpdate_Click"  OnClientClick="return confirm('是否进行修改？')" Text="查看详情" />
